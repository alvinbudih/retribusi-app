              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control form-control-sm @error('cc') is-invalid @enderror" id="cc" placeholder="Isi Silinder" name="cc" value="{{ old('cc', (request('noUjiCari') ? $kendaraan->cc : '')) }}" autocomplete="off">
                    @error("cc")
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
